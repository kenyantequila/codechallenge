function calculateNetSalary(basicSalary, benefits) {
    ...
    // Constants for tax rates and deductions from the table
    const TAX_BRACKETS = [
    ...
    const NSSF_RATE = 0.06; // This is just 6%

    // Calculation for gross salary
    const grossSalary = basicSalary + benefits;

    // tax calculation-find the bracket that the gross salary falls into 
    ...
    // Calculate NSSF deductions-multiply
...
// prompts for basic calculating net salary(line1)
